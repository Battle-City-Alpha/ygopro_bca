...
struct Config {
	...
	int number_card_hand_test_hand;
	bool shuffle_deck_test_hand;
	bool forced;
...
public:
	...
	void AddChatMsg(const wchar_t* msg, int player, bool recieve = true);
	void ClearChatMsg();
	...
	recti ResizeCardImgWin(s32 x, s32 y, s32 x2, s32 y2);
	recti ResizeButtonNearCardInfos(s32 y, s32 y2);
	...
	irr::gui::IGUIStaticText* stBoosterInfo;
	...
	irr::gui::IGUIStaticText* stPlayReplay;
	irr::gui::IGUIStaticText* stStartReplayTurn;
	irr::gui::IGUIStaticText* stMainMessage;
	irr::gui::IGUIStaticText* stReplay;
	//single play
	...
	irr::gui::IGUIStaticText* stBooster;
	...
	irr::gui::IGUIComboBox* cbBoosters;
	...
	bool handtest_mode = false;
	//restart
	irr::gui::IGUIButton* btnRestartSingle;

	CGUISkinSystem* skinSystem;

	irr::gui::IGUIStaticText* stSkins;
	irr::gui::IGUIComboBox* cbSkins;
	irr::gui::IGUIStaticText* stCardsCountHandTest;
	irr::gui::IGUIComboBox* cbCardsCountHandTest;
	irr::gui::IGUICheckBox* chkShuffleHandTest;

	irr::gui::IGUICheckBox* chkSearchBCACardsOnly; 
	
	irr::gui::IGUITab* tabHelperOwner;
	irr::gui::IGUITab* tabSystemOwner;

	irr::gui::IGUIStaticText* stDimension;

	irr::gui::IGUICheckBox* chkShowBoosterTagDeckEditor;

	bool KaibotHostMode = false;
	irr::gui::IGUIStaticText* stRule;
	irr::gui::IGUIComboBox* cbBotDecks;
...
#define CHECKBOX_BCA_SEARCH			993
#define COMBOBOX_BOOSTERS			994
#define COMBOBOX_START_HAND_COUNT_HAND_TEST				995
#define CHECKBOX_SHUFFLE_HAND_TEST	996
#define COMBOBOX_SKINS				997
#define BUTTON_RESTART_SINGLE		998
#define BUTTON_HAND_TEST			999
